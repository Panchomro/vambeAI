...
export default function TimelineChart({ data }: { data: TimelinePoint[] }) {
  return (
    <div className="card">
      <h3 className="font-semibold text-slate-800 dark:text-white mb-1">Reuniones por mes</h3>
      <p className="text-xs text-slate-400 dark:text-slate-500 mb-4">Total de reuniones y cierres en el tiempo</p>
